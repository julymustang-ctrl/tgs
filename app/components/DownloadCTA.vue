<template>
  <section id="download" class="py-20 lg:py-32 relative overflow-hidden">
    <!-- Background Gradient -->
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      >
        ...
        <a 
          href="#" 
          class="group flex items-center gap-4 bg-white text-charcoal px-8 py-5 rounded-2xl hover:bg-taxi-yellow transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-taxi-yellow/20"
        >
          ...
          <div class="text-left">
            ...
            <div class="text-xl font-semibold">İndirin</div>
          </div>
        </a>
      ...
      <div 
        ...
        class="mt-16"
      >
        <p class="text-white/50 text-sm mb-4">veya QR kodu taraTaq</p>
