        ...
        <div class="text-center lg:text-left flex flex-col items-center lg:items-start">
          ...
          >
            <a 
              :href="androidLink"
              target="_blank"
              class="group flex items-center justify-center gap-4 px-8 py-5 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 w-full sm:w-auto"
              :class="isDark 
                ? 'bg-white hover:bg-gray-100 text-charcoal shadow-white/10' 
                : 'bg-charcoal hover:bg-zinc-900 text-white shadow-charcoal/20'"
            >
              <!-- Apple Logo -->
              <svg viewBox="0 0 24 24" class="w-7 h-7 text-current">
