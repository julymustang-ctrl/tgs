  ...
  <div class="min-h-screen dark:bg-charcoal bg-gray-50">
    ...
    <main class="pt-24 pb-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Empty State -->
        <div v-if="!articles || !articles.length" class="text-center py-20">
...
// Fetch articles for current locale using collection
const { data: articles } = await useAsyncData(`blog-list-${currentLocale.value}`, async () => {
  try {
    // Query all content and filter by path
