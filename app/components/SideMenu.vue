    ...
    >
      ...
      >
        ...
        <div class="flex items-center justify-between p-4 border-b" :class="isDark ? 'border-white/10' : 'border-charcoal/10'">
          ...
          <a 
            href="#"
            @click.prevent="(() => { trackDriverDownload(); handleAppDownload('driver'); })()"
...
const { driverAndroidLink, handleAppDownload } = useUserType()
const { t } = useI18n()
...
const socialLinks = [
  ...
  { 
    name: 'X', 
    href: 'https://twitter.com/tagsico', 
